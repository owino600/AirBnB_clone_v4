...
ssh() {
	...
	echo "   .. Which Server?? .."
	echo ""
	echo "(1) 123-web-01 = 100.25.130.166 "
	echo "(2) 123-web-02 = 52.23.177.226 "
	echo "(3) 123-lb-01 = 34.229.68.146 "
	...
	echo "... please wait"
	if [[ "$IPADDRESS" == 1 ]]; then
	    command ssh ubuntu@100.25.130.166 -i ~/.ssh/holberton
	elif [[ "$IPADDRESS" == 2 ]]; then
	    command ssh ubuntu@52.23.177.226 -i ~/.ssh/holberton
	elif [[ "$IPADDRESS" == 3 ]]; then
	    command ssh ubuntu@34.229.68.146 -i ~/.ssh/holberton
